package com.jby.chaforgoogle.exportFeature.category.searchFeature;
...
public class ExportCategorySearchCategoryAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ExportCategorySearchCategoryObject> categoryListViewArrayList;
    private CategoryAdapterCallBack categoryAdapterCallBack;
    private SparseBooleanArray mSelectedItemsIds;

    public ExportCategorySearchCategoryAdapter(Context context, ArrayList<ExportCategorySearchCategoryObject> categoryListViewArrayList, CategoryAdapterCallBack categoryAdapterCallBack)
    {
    ...
    @Override
    public ExportCategorySearchCategoryObject getItem(int i) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ExportCategorySearchCategoryObject object = getItem(i);
