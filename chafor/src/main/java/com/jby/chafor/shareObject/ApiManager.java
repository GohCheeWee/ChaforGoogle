package com.jby.chafor.shareObject;
...
//    login and registration
    public String register = domain + "/chafor/registration/register.php";
    public String login = domain + "/chafor/registration/login.php";

    public String feature = domain + "/chafor/package/feature.php";
