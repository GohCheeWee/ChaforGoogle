package com.jby.chafor.exportFeature.subcategory.scanner;
...
import static com.jby.chafor.exportFeature.subcategory.SubCategoryActivity.REFRESH_LIST_VIEW;
...
/*            ImageView imageView = (ImageView) findViewById(R.id.image);
    ...
    public void insertSubCategoryItem(String barcode, String quantity) {
        ...
        int insertSubCategory = new CustomSqliteHelper(this).saveSubCategory(count, categoryID, barcode, scanQuantity);
