package com.jby.chafor.exportFeature.subcategory;
...
import com.jby.chafor.exportFeature.subcategory.scanner.CaptureActivity;
import com.jby.chafor.exportFeature.subcategory.subcategory.SubCategoryExistedDialog;
import com.jby.chafor.exportFeature.subcategory.subcategory.SubCategoryInsertDialog;
import com.jby.chafor.exportFeature.subcategory.subcategory.SubCategoryListViewAdapter;
import com.jby.chafor.exportFeature.subcategory.subcategory.SubCategoryObject;
import com.jby.chafor.exportFeature.subcategory.subcategory.SubCategoryUpdateDialog;
import com.jby.chafor.exportFeature.subcategory.subcategory.takeAction.TakeActionActivity;
...
//            if not found
            ...
            subCategoryLabelListView.setVisibility(View.INVISIBLE);
    ...
    public void updateSubCategoryItem(String barcode, String quantity, String selectedID) {
        ...
        int updateSubCategory = customSqliteHelper.updateSubCategory(count, categoryID, barcode, updateQuantity, selectedID);
    ...
    public void insertSubCategoryItem(String barcode, String quantity) {
        ...
        int insertSubCategory = customSqliteHelper.saveSubCategory(count, categoryID, barcode, scanQuantity);
